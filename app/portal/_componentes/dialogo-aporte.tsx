 ...
 * e o `overflow` do cabecalho onde o menu mora.
 *
 * Quem abre é o menu, entao a `ref` vem de fora.
 */
export function DialogoDeAporte({
  dialogo,
}: {
    ...
    >
      <div className="flex flex-col items-center px-6 pt-9 pb-6 text-center">
        ...
        <div className="mt-7 flex w-full flex-col gap-2.5">
          {/* Link de verdade, e nao um botao com `window.open`: preserva abrir
              em nova aba, copiar endereco e o aviso de saida do app. */}
          <a
            href={WHATSAPP}
            target="_blank"
