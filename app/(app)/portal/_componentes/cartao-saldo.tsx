...
export function CartaoSaldo({
  ...
  return (
    ...
    <div className="sombra-cartao hover:sombra-cartao-alta mx-auto w-full max-w-sm animate-surgir rounded-2xl md:rounded-lg bg-white px-5 py-4 ring-1 ring-tinta/10 transition-shadow duration-300 md:flex md:max-w-none md:items-center md:justify-between md:gap-10 md:px-8 md:py-6 lg:mb-7 [animation-delay:90ms]">
      {/*
