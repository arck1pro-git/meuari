 ...
 *
 * A fila de abas que aparecia no topo a partir do desktop saiu daqui, e nao
 * foi substituida: no desktop o /portal mostra as tres secoes de uma vez —
 * carteira, obra e simulador —, entao nao ha para onde navegar. Esta barra
 * existe para o celular, onde as tres continuam sendo telas separadas.
 */
const SECOES = [
